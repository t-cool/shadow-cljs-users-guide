...
////
:browser ターゲットは、HUDを使って、ビルドが開始されたときにローディングインジケータを表示するようになりました。また、警告やエラーが発生した場合にも表示されます。
...
////
.Example public/css/main.css` は `/foo/css/main.css` の下でサーブされます。
